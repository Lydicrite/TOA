...
namespace TheoryOfAutomatons.Automaton
{
    internal class AutomatonCreator
    {
        ...
        (
            ...
            NumericUpDown circleDiameter, NumericUpDown border, NumericUpDown dSDNUD, NumericUpDown tBPNUD, NumericUpDown tLPNUD,
            PictureBox cCP, PictureBox aBCP, PictureBox iBCP, PictureBox hBCP, PictureBox iSCP, PictureBox tBPCP, PictureBox tLPCP,
        ...
        public static string GenerateRandomString(int n, List<char> symbols)
        {
        ...
        public void LoadParameters(int index, int cD, int bW)
        {
            DFATypeSelectorCB.SelectedIndex = index;
